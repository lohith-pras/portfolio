...
- [ ] **Phase 2: Static Shell** - Navigation + About section as verified static HTML with i18n strings, no animations
- [ ] **Phase 3: Hero** - Shader gradient, name display, GSAP scramble entry, ScrollTrigger fade
